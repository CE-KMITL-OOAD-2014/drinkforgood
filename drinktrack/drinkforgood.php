		...
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="content/tipGood.php">Good</a></li>
						<li><a class="ajax-link" href="content/tipBad.php">Bad</a></li>
						
					</ul>
				</li>
				<li class="dropdown">
					<a class="ajax-link" href="content/aboutUs.php" class="dropdown-toggle">
				...
				<li class="dropdown">
					<a class="ajax-link" href="content/contact.php" class="dropdown-toggle">
